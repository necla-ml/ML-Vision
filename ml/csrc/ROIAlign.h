...
at::Tensor ROIAlign_forward(
    ...
    const float spatial_scale_x, // The scale of the image features. ROIs will be scaled to this.
    const float spatial_scale_y, // The scale of the image features. ROIs will be scaled to this.
...
// along each axis.
{
  ...
  return ROIAlign_forward_cpu(
      input, rois, spatial_scale_x, spatial_scale_y, pooled_height, pooled_width, sampling_ratio);
}
