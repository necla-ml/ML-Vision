OBJECT365_CLASSES = [
    ...
    'Monitor/TV', 'Backpack', 'Umbrella', 'Traffic Light', 'Speaker', 'Watch',
    ...
    'Pickup Truck', 'Fork', 'Traffic Sign', 'Balloon', 'Tripod', 'Dog',
    'Spoon', 'Clock', 'Pot', 'Cow', 'Cake', 'Dinning Table', 'Sheep', 'Hanger',
    ...
    'Parrot', 'Seal', 'Butterfly', 'Dumbbell', 'Donkey', 'Lion', 'Urinal',
