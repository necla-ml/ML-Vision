...
class ROIPoolFunction : public torch::autograd::Function<ROIPoolFunction> {
 public:
  static torch::autograd::variable_list forward(
    ...
    ctx->saved_data["spatial_scale_height"] = spatial_scale_height;
    ctx->saved_data["spatial_scale_width"] = spatial_scale_width;
    ctx->saved_data["pooled_height"] = pooled_height;
    ctx->saved_data["pooled_width"] = pooled_width;
    ctx->saved_data["input_shape"] = input.sizes();
    at::AutoDispatchBelowADInplaceOrView g;
    auto result =
        roi_pool(input, rois, spatial_scale_height, spatial_scale_width, pooled_height, pooled_width);
  ...
  static torch::autograd::variable_list backward(
    ...
    auto grad_in = detail::_roi_pool_backward(
        ...
        rois,
        argmax,
        ctx->saved_data["spatial_scale_height"].toDouble(),
        ctx->saved_data["spatial_scale_width"].toDouble(),
...
std::tuple<at::Tensor, at::Tensor> roi_pool_autograd(
  ...
  auto result = ROIPoolFunction::apply(
      input, rois, spatial_scale_height, spatial_scale_width, pooled_height, pooled_width);
...
TORCH_LIBRARY_IMPL(mlvision, Autograd, m) {
  m.impl(
