...
CLI = ['train', 'test']
X101_WSL = ['resnext101_32x8d_wsl', 'resnext101_32x16d_wsl', 'resnext101_32x32d_wsl', 'resnext101_32x48d_wsl']
best_acc1 = 0

class ImageNetTRT(nn.Module):
    def __init__(self, engine, classifier):
        r"""
        Args:
            backbone: TensorRT engine of backbone model
            classifier: FC layer from original model
        """
        super(ImageNetTRT, self).__init__()
        self.backbone = engine
...
def launch(argv):
    ...
    parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet18',
                        ...
                        help='model architecture: ' +
                             ' | '.join(model_names) +
                             ' (default: resnet18)')
    parser.add_argument('--deploy', action='store_true', help='model deployment with TensorRT')
    parser.add_argument('--deploy-size', default=[224], nargs='+', help='model deployment option of max input image size')
    parser.add_argument('--deploy-fp16', action='store_true', help='model deployment option of float16')
    parser.add_argument('--deploy-int8', action='store_true', help='model deployment option of int8')
    parser.add_argument('--deploy-strict', action='store_true', help='model deployment option of strict_type_constraints')
    parser.add_argument('--deploy-reload', action='store_true', help='rebuild model deployment')
